...
import type PolitiqueConfidentialiteContent from "~/types/content/politiqueConfidentialiteContent";
import type MentionsLegalesContent from "~/types/content/mentionsLegalesContent";
import type ParticipationCharter from "~/types/participation_charter/participationCharter";
import type DeclarationAccessibiliteContent from "~/types/content/declarationAccessibiliteContent";
import type ConditionGeneralesContent from "~/types/content/conditionGeneralesContent";
import type QuestionAuGouvernementContent from "~/types/content/questionAuGouvernementContent";
